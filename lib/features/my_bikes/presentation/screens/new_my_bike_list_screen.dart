...
import 'package:smartbike_flutter/features/my_bikes/presentation/screens/new_bike_admin_screen.dart';
            ...
            children: [
              ...
              Consumer(
                builder: (BuildContext context, WidgetRef ref, Widget? child) {
                  ...
                  return  role == null ? ProgressIndicatorView() : _bikeListView();
                },
              )
            ],
          ),
  ...
  Widget _titleHeadingBar() {
    return Row(
      children: [
        ...
        //   },
        // ),
        text(title : LocaleKeys.keyMyBike.tr(), maxLines:1,fontSize: 20.sp, color: blueColor, fontWeight: FontWeight.w500),
        10.pw,
        // Consumer(
        //   builder: (BuildContext context, WidgetRef ref, Widget? child) {
        //     final isRole =  ref.watch(myBikeNativeController.select((value) => value.isRole));
        ...
        //             }
        //             Navigator.push(context, MaterialPageRoute(builder: (context) => VehicleAdminScreen(),));
        //           },
          ...
          builder: (BuildContext context, WidgetRef ref, Widget? child) {
            ...
            return Visibility(
              ...
              child: InkWell(
                  ...
                  // child: Image.asset( isRole == false ? icScanner : icAdmin, scale: isRole == false ? 2.8.h : 3.1.h)),
                  child: Image.asset(icScanner, scale : 3.1.h)),
            );
          },
        ),
        Spacer(),
